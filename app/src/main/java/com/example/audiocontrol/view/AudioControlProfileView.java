...
public class AudioControlProfileView extends FrameLayout {
    private TextView mTitle;
    private View deleteButton;
    private Button activeButton;

    public AudioControlProfileView(Context context) {
        super(context);
        init();
    }

    public AudioControlProfileView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public AudioControlProfileView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public AudioControlProfileView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
